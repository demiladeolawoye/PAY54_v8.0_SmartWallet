...
highPriorityExceptions:
    ...
    TX_EXCEPTIONS.filter(
        ...
        exception =>
            ...
            Array.isArray(exception.attachments) &&
...
/* =========================
   ADD EXCEPTION ACTIVITY
========================= */

function addTransactionExceptionActivity(
