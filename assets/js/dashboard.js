...
function openCards(){
  ...
  function renderUI(){
    ...
    const statusText  = cardState.status === "active" ? "Active" : "Frozen";
    ...
    return `
      <div style="text-align:center">
        ...
        ">
          <div style="font-size:14px;opacity:.8">PAY54 Virtual Card</div>
          <div style="font-size:20px;font-weight:900;margin-top:6px">${cardState.number}</div>
          <div style="margin-top:6px">${cardState.expiry}</div>
        </div>

        <div style="margin-bottom:12px;font-weight:800;color:${statusColor}">
          ● ${statusText}
        </div>

        <div class="p54-actions" style="justify-content:center;flex-wrap:wrap">

          <button class="p54-btn" id="freezeBtn">
            ${cardState.status === "active" ? "Freeze Card" : "Unfreeze Card"}
          </button>

          <button class="p54-btn" id="limitBtn">Set Limit</button>

          <button class="p54-btn" id="fundBtn">Fund Card</button>
  ...
  openModal({
    ...
    onMount: ({modal, close}) => {
      ...
      /* 🔥 FREEZE / UNFREEZE */
      modal.querySelector("#freezeBtn").addEventListener("click", () => {

        cardState.status = cardState.status === "active" ? "frozen" : "active";
      ...
      /* 🔥 SET LIMIT */
      modal.querySelector("#limitBtn").addEventListener("click", () => {

        const newLimit = Number(prompt("Enter spending limit"));
      ...
      /* 🔥 FUND CARD */
      modal.querySelector("#fundBtn").addEventListener("click", () => {
